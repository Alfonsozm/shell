...
static void add_token(char *start, char *end) {
...
static void fill_tokens(char *str) {
    char *start;
...
tline *tokenize(char str[]) {
    ...
    for (i = 0; i < ntokens; i++) {
        ...
        if (tokens[i][0] == '|') {
            ...
            line.commands[line.ncommands - 1].argv = realloc(line.commands[line.ncommands - 1].argv,
                                                             (line.commands[line.ncommands - 1].argc + 2) *
                                                             sizeof(char *));
